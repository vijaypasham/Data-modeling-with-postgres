...
"""processing the songs file data for loading into the songs and artists table"""
...
"""Processing the log file data for loading into the user and time tables."""
def process_log_file(cur, filepath):
    ...
    # convert timestamp column to datetime and insert datetime values.
